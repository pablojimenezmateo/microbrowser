...
1587 of 9029 subtests pass (17.6%) over 768 tests.

**Do not quote that number.** Subtests are not comparable across areas: `dom/nodes` alone is 57% of every subtest here.
...
| tests | cause | example |
|--:|---|---|
| 158 | TIMEOUT: the page never reported | `console/console-label-conversion.any.worker.html` |
| 51 | TIMEOUT:  | `dom/abort/abort-signal-any.any.worker.html` |
| 30 | ERROR: TypeError: Illegal constructor: Document | `dom/nodes/Node-compareDocumentPosition.html` |
| 12 | TIMEOUT: the page never reported; first script error: inline script #N: SyntaxError: unexpected token '<' (line N) SyntaxError: unexpected token '<' ... | `dom/nodes/Element-childElement-null-xhtml.xhtml` |
...
|--:|--:|---|---|
| 25 | 64 | Test timed out | `dom/events/Event-dispatch-on-disabled-elements.html` |
...
| 13 | 23 | assert_throws_js: function "function TypeError() { [native code] }" is not an Error subtype | `dom/events/EventTarget-dispatchEvent.html` |
...
| 11 | 695 | NOTRUN (no message) | `dom/events/Event-dispatch-on-disabled-elements.html` |
...
| 11 | 102 | undefined (createProcessingInstruction) is not a function | `dom/events/EventTarget-this-of-listener.html` |
| 10 | 484 | assert_throws_dom: function "function () { [source unavailable] }" did not throw | `dom/events/EventTarget-dispatchEvent.html` |
...
| 7 | 14 | Illegal constructor: Document | `dom/events/Event-dispatch-bubbles-false.html` |
| 7 | 28 | cannot read property 'document' of undefined | `dom/events/event-global-extra.window.html` |
| 7 | 14 | undefined (createAttribute) is not a function | `dom/attributes-are-nodes.html` |
...
| 2 | 41 | DOMParser is not defined | `dom/nodes/Node-normalize.html` |
| 2 | 3 | Illegal constructor: DocumentFragment | `dom/nodes/DocumentFragment-constructor.html` |
...
| 2 | 4 | assert_equals: expected "" but got "null" | `dom/nodes/CharacterData-data.html` |
...
| 2 | 9 | undefined is not a function | `dom/nodes/Document-createCDATASection-xhtml.xhtml` |
...
| 1 | 1 | 'in' requires an object | `dom/nodes/moveBefore/Node-moveBefore.html` |
| 1 | 1 | DOMImplementation is not defined | `dom/nodes/Document-implementation.html` |
| 1 | 1 | HTMLBodyElement is not defined | `dom/events/Body-FrameSet-Event-Handlers.html` |

744 distinct subtest messages and 23 distinct harness messages behind these numbers.
