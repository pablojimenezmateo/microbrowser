...
void RegisterFontCatalogTests(std::vector<TestCase>& tests) {
  AddTest(tests, "FontCatalog/PicksTheNearestWeightWithinAFamily", [] {
    ...
    Expect(FontCatalog::MatchDistance("Test", 400, false, FontRequest{"Test", 16.0f, 500, false},
                                      "test") <
               FontCatalog::MatchDistance("Test", 700, false,
                                          FontRequest{"Test", 16.0f, 500, false}, "test"),
           "500 is nearer 400 than 700");
    Expect(FontCatalog::MatchDistance("Test", 700, false, FontRequest{"Test", 16.0f, 600, false},
                                      "test") <
               FontCatalog::MatchDistance("Test", 400, false,
                                          FontRequest{"Test", 16.0f, 600, false}, "test"),
  ...
  AddTest(tests, "FontCatalog/SlantOutranksWeight", [] {
    ...
    Expect(FontCatalog::MatchDistance("Test", 900, true, italic, "test") <
               FontCatalog::MatchDistance("Test", 400, false, italic, "test"),
           "any italic beats any upright for an italic request");
  });

  AddTest(tests, "FontCatalog/TheRightFamilyOutranksEverything", [] {
    const FontRequest request{"Test", 16.0f, 400, false};
    Expect(FontCatalog::MatchDistance("Test", 900, true, request, "test") <
               FontCatalog::MatchDistance("Other", 400, false, request, "test"),
           "a face from the wrong family is never a better answer than one from the right "
           "family, however well its weight matches");
  });
