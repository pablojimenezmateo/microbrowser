...
std::vector<TestCase> CollectTests() {
  ...
  microbrowser::tests::RegisterColorTextTests(tests);
  microbrowser::tests::RegisterScrollTests(tests);
  microbrowser::tests::RegisterCssTests(tests);
  microbrowser::tests::RegisterSelectorTests(tests);
  ...
  microbrowser::tests::RegisterFrameTests(tests);
  ...
  microbrowser::tests::RegisterWptCertificateTests(tests);
  microbrowser::tests::RegisterWptExpectationsTests(tests);
  microbrowser::tests::RegisterWptHandlerTests(tests);
  microbrowser::tests::RegisterWptReftestTests(tests);
  microbrowser::tests::RegisterWptServerTests(tests);
  microbrowser::tests::RegisterWptSummaryTests(tests);
  ...
  microbrowser::tests::RegisterJsRealmTests(tests);
